  ...
  return <div className="flex gap-4">
      <div className="relative flex-1">
        <input
          ...
          className="w-full h-14 pl-14 pr-6 text-lg rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all outline-none"
          value={value}
